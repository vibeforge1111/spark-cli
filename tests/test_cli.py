...
"""
    ...
    def test_install_script_bootstraps_local_prefix_contract(self) -> None:
        ...
        self.assertIn("Python $SPARK_PYTHON_VERSION not found; pinned uv", script)
    ...
    def test_windows_install_script_bootstraps_local_prefix_contract(self) -> None:
        ...
        self.assertIn("Get-InstallerPythonVersionTuple", script)
        self.assertIn("python3.11", script)
        self.assertIn("sys.version_info[:2] == ($major, $minor)", script)
        self.assertIn("Python $PythonVersion not found; pinned uv", script)
        self.assertIn("pinned uv", script)
