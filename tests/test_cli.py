...
class SparkCliTests(unittest.TestCase):
    ...
    def test_approval_classifier_flags_alembic_migrations(self) -> None:
        for command in (
        ...
        current = approval_required_for_command(["alembic", "current"], CommandContext(non_interactive=True))
