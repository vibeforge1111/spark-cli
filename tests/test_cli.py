...
class SparkCliTests(unittest.TestCase):
    ...
    def test_approval_classifier_hardens_secret_publish_and_wrapper_gaps(self) -> None:
        cases = [
            ...
            (["kubectl", "get", "secret/spark-token", "-o", "yaml"], "credential_mutation", "critical"),
            (["kubectl", "get", "secrets/spark-token", "-o", "yaml"], "credential_mutation", "critical"),
            (["kubectl", "describe", "secret/spark-token"], "credential_mutation", "critical"),
