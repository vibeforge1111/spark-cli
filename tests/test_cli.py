...
class SparkCliTests(unittest.TestCase):
    ...
    def test_guide_prints_normie_onboarding_surface(self) -> None:
        ...
        self.assertIn("Choose what Spark can do", output)
        self.assertIn("Use /access 4 only", output)
    ...
    def test_guide_advanced_prints_expert_surface(self) -> None:
        ...
        self.assertIn("Requested builds and missions", output)
        self.assertIn("Default.", output)
        self.assertIn("Does not inspect local folders", output)
        self.assertIn("Local projects, files on this computer", output)
    ...
    def test_setup_default_bundle_registers_starter_stack(self) -> None:
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            self.assertIn("Allowed by default: chat, memory, diagnostics, public research, and approved missions.", setup_output)
            self.assertIn("Local files and workspaces stay off by default", setup_output)
...
"""
    ...
    def test_install_script_bootstraps_local_prefix_contract(self) -> None:
        ...
        self.assertIn('SPARK_DEFAULT_CLI_REF="33f52540d070fd1b7ddd3c0eca68cd353c85795b"', script)
        ...
        self.assertIn("Use /access 4 only", script)
    ...
    def test_windows_install_script_bootstraps_local_prefix_contract(self) -> None:
        ...
        self.assertIn('[string]$Ref = "33f52540d070fd1b7ddd3c0eca68cd353c85795b"', script)
