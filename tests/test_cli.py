...
class SparkCliTests(unittest.TestCase):
    ...
    def test_guide_advanced_prints_expert_surface(self) -> None:
        ...
        self.assertIn("--openai-api-key @clipboard", output)
        self.assertIn("--zai-api-key @clipboard", output)
        self.assertIn("--openrouter-api-key @clipboard --openrouter-model <MODEL>", output)
        self.assertNotIn("<OPENAI_API_KEY>", output)
        self.assertNotIn("<ZAI_API_KEY>", output)
        self.assertNotIn("<KIMI_API_KEY>", output)
