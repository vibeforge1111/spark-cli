...
class SparkCliTests(unittest.TestCase):
    ...
    def test_approval_classifier_hardens_secret_publish_and_wrapper_gaps(self) -> None:
        cases = [
            ...
            (["bash", "-c", "echo", "pwned"], "remote_code_execution", "critical"),
            (["sh", "-lc", "echo", "pwned"], "remote_code_execution", "critical"),
            (["cmd", "/c", "echo", "pwned"], "remote_code_execution", "critical"),
            (["powershell", "-EncodedCommand", "ZQBjAGgAbwAgAHAAdwBuAGUAZAA="], "remote_code_execution", "critical"),
            (["pwsh", "-Command", "Write-Output", "pwned"], "remote_code_execution", "critical"),
