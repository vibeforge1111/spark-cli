...
class SparkCliTests(unittest.TestCase):
    ...
    def test_approval_classifier_flags_prisma_migration_deploy(self) -> None:
        for command in (
            ...
            with self.subTest(command=command):
                ...
                self.assertEqual(decision.approval_mode, "blocked")
                self.assertEqual(decision.confirmation_phrase, "approve database migration")

        pull = approval_required_for_command(["prisma", "db", "pull"], CommandContext(non_interactive=True))
