...
class SparkCliTests(unittest.TestCase):
    ...
    def test_approval_classifier_flags_edge_hosted_deploy(self) -> None:
        cases = [
        ...
        status = approval_required_for_command(["netlify", "status"], CommandContext(non_interactive=True))
