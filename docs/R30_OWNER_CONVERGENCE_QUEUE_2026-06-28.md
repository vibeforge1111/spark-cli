...
`3e8d6079e3000a38df33e622bebb33f8e054b746`; dirty release repo count remained
...
| 6 | `spark-cli` | remote R29 release tag `7751ef43581c`; remote `master` `a6738be7a97a` | `3e8d6079e300` | local installer stays R29 until source/registry truth is green | Port/push R30 docs, voice discovery, publication-order gates, Access 5 anti-read-only verifier hardening, the Telegram owner-handoff patch gate, the direct owner manifest patch gate, and the voice prepared-lane commit proof gate before installer pins move to R30. |
