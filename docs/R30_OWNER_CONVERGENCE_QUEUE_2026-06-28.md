...
| Direct R30 | `spawner-ui` | `7b31391560a4` | `19b7d0bff144` | `19b7d0bff144` | `head_differs_from_registry` |
...
| 3 | `spawner-ui` | `main` / `spark-ship-2026-06-26` at `451d009aad84`; owner release branch `fdb8fded4744` | `7b31391560a4` | registry/installed `19b7d0bff144` | Port or push PRD proof-continuity, Level 5 Codex sandbox, shared effective-env worker access/path validation, and Codex worker env propagation fixes. |
