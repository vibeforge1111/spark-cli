...
| Domain Chip Labs creator UX | First Telegram creator-routing slice is local-only at `0cf6e5c`; full creator lane remains governed by `docs/R30_DOMAIN_CHIP_LABS_TELEGRAM_CREATOR_PLAN_2026-06-28.md` and `docs/R30_DCL_SPAWNER_READINESS_SPEC_2026-06-28.md`. | Natural Telegram chip creation must become a measured DCL creator lane with intent lock, capability truth, DCL artifact contract, verifiable loop engineering, and regression tests before R30 claims this as installer-ready UX. |
