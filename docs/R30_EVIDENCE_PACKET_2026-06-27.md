...
- `spark-telegram-bot`: owner handoff tree-diff patch `docs/r30/patches/r30-telegram-control-reliability-stack.patch` has SHA256 `5b3f824ae0ef13495a784572e118ae35ec4c5a8f4a11b73b1256515940da785f`; applying it to public owner base `67ad9e6ed297` produces tree `0b4112a97ab8`, carrying local proof head `6f48013edb22` as review/apply material only, not registry or publication authority.
...
- The Telegram patch still emits the known one-line blank-EOF whitespace
  ...
  `0b4112a97ab8cd4ce6c593e11bd4eee2c3044d6b`.
