...
| --- | --- | --- | --- |
| `spark-telegram-bot` | `main` / `spark-ship-2026-06-26` at `67ad9e6ed297` | local `464cce413efe` | registry `e5a1bd040986` |
