...
| `spark-telegram-bot` | `28aecd8ddfb` (`28aecd8ddfb49dde730926df37ba3c81c55c6617`) on `harness-discipline-line-count-gate` | no matching owner branch found; remote `main` `67ad9e6ed297`; tag `spark-ship-2026-06-22` `e5a1bd040986` | registry pin `e5a1bd040986`; classified `local_runtime_test_artifact` | Push/port `28aecd8ddfb` or an equivalent owner release commit before changing registry. |
