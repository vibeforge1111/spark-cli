...
| `spawner-ui` | `97cb911bf7ac` on `release/stability-2026-06-02-spawner-authority` | owner branch `fdb8fded4744`; remote `main` and `spark-ship-2026-06-26` `451d009aad84`; registry baseline tag `spark-ship-2026-06-22` `19b7d0bff144` | registry pin `19b7d0bff144`; classified `local_runtime_test_artifact` | Push/port the local merge/fix stack, including direct-client, PRD-lane, and persisted Level 5 Codex sandbox fixes, onto the current owner release base before changing registry. |
