...
| `spark-telegram-bot` | `4a630b3e72bd` (`4a630b3e72bdbb761a8a85af437a0751e0854723`) on `harness-discipline-line-count-gate` | no matching owner branch found; remote `main` and `spark-ship-2026-06-26` `67ad9e6ed297`; registry baseline tag `spark-ship-2026-06-22` `e5a1bd040986` | registry pin `e5a1bd040986`; classified `local_runtime_test_artifact` | Push/port `4a630b3e72bd` or an equivalent owner release commit onto the current owner release base before changing registry. |
| `spawner-ui` | `7110dce4030a` on `release/stability-2026-06-02-spawner-authority` | owner branch `fdb8fded4744`; remote `main` and `spark-ship-2026-06-26` `451d009aad84`; registry baseline tag `spark-ship-2026-06-22` `19b7d0bff144` | registry pin `19b7d0bff144`; classified `local_runtime_test_artifact` | Push/port the local merge/fix stack, including direct-client and PRD-lane Level 5 Codex sandbox fixes, onto the current owner release base before changing registry. |
...
Fresh `git ls-remote` audit on 2026-06-27 confirmed newer public owner refs that are not yet registry truth for R30:

| Repo | Fresh public owner ref | R30 local/proof ref | Registry/install truth |
| --- | --- | --- | --- |
| `spark-telegram-bot` | `main` / `spark-ship-2026-06-26` at `67ad9e6ed297` | local `4a630b3e72bd` | registry `e5a1bd040986` |
| `spawner-ui` | `main` / `spark-ship-2026-06-26` at `451d009aad84`; owner release branch `fdb8fded4744` | local `7110dce4030a` | registry `19b7d0bff144` |
