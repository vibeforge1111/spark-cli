...
Fresh `git ls-remote` audit on 2026-06-27 confirmed newer public owner refs that are not yet registry truth for R30. Rechecked at `2026-06-28T02:08:33Z`; the direct-blocker owner refs below still matched the packet:

| Repo | Fresh public owner ref | R30 local/proof ref | Registry/install truth |
| --- | --- | --- | --- |
| `spark-telegram-bot` | `main` / `spark-ship-2026-06-26` at `67ad9e6ed297` | local `ce4a234d6ae` | registry `e5a1bd040986` |
| `spawner-ui` | `main` / `spark-ship-2026-06-26` at `451d009aad84`; owner release branch `fdb8fded4744` | local `3042f8acbdde` | registry `19b7d0bff144` |
