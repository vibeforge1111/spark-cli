...
Fresh `git ls-remote` audit on 2026-06-27 confirmed newer public owner refs that are not yet registry truth for R30. Rechecked at `2026-06-28T01:53:39Z`; the direct-blocker owner refs below still matched the packet:

| Repo | Fresh public owner ref | R30 local/proof ref | Registry/install truth |
| --- | --- | --- | --- |
| `spark-telegram-bot` | `main` / `spark-ship-2026-06-26` at `67ad9e6ed297` | local `d2f13ee33044` | registry `e5a1bd040986` |
