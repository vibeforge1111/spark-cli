...
| --- | --- | --- | --- |
| `spark-telegram-bot` | `main` / `spark-ship-2026-06-26` at `67ad9e6ed297` | local `8958d01a80a4` | registry `e5a1bd040986` |
| `spawner-ui` | `main` / `spark-ship-2026-06-26` at `451d009aad84`; owner release branch `fdb8fded4744` | local `d7737038dc85` | registry `19b7d0bff144` |
