...
| --- | --- | ---: | ---: | --- | --- |
| `spark-telegram-bot` | `e5a1bd0409865ddb3024c15ed35ccd0038e31776..6188d43fbb465898c35c8228742decfc4be5c7b8` | 1011 | 330 | first `43aeb4e476b9` / last `6188d43fbb46` | `git log --reverse --oneline e5a1bd0409865ddb3024c15ed35ccd0038e31776..6188d43fbb465898c35c8228742decfc4be5c7b8` |
...
- `spark-telegram-bot`: reliability, build, line-count, profile-specific Level 5 env proof, and mixed access/build Level 5 full-permission proof gates passed. Owner handoff patch `docs/r30/patches/r30-telegram-control-reliability-stack.patch` has SHA256 `dc9a03c6678b0425e3a47613647543146255c54d4859e47540be8d0b92cc1461`; applying the tree-diff patch to public owner base `67ad9e6ed297` produces tree `6159f909c49d`, carrying local proof head `6188d43fbb46` as review/apply material only, not registry or publication authority.
...
- `spark-telegram-bot`: `r30-telegram-control-reliability-stack.patch`
  ...
  `6159f909c49da15ec88bbf0a0a665347da6d9b33`. `git apply` still reports
...
git log --oneline e5a1bd0409865ddb3024c15ed35ccd0038e31776..6188d43fbb465898c35c8228742decfc4be5c7b8
...
`e5a1bd040986..6188d43fbb46` reliability ladder, access activation stack, health-token preservation fix, `Harden Telegram profile Level 5 env proof`, active-profile stale read-only env proof, startup profile-env refresh over stale read-only process env, Level 5 full-permission audit doc, and mixed access/build Level 5 full-permission proof hardening into an owner release ref,
...
Range: `e5a1bd0409865ddb3024c15ed35ccd0038e31776..6188d43fbb465898c35c8228742decfc4be5c7b8`

Top commits currently in the R30 handoff stack:

- `6188d43 Harden mixed Level 5 access proof`
