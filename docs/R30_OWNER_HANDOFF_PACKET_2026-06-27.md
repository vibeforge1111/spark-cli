...
| --- | --- | ---: | ---: | --- | --- |
| `spark-telegram-bot` | `e5a1bd0409865ddb3024c15ed35ccd0038e31776..3323a656b890f88262e88d862e2787c9a2f092ae` | 1058 | 392 | first `43aeb4e476b9` / last `3323a656b890` | `git log --reverse --oneline e5a1bd0409865ddb3024c15ed35ccd0038e31776..3323a656b890f88262e88d862e2787c9a2f092ae` |
...
- `spark-telegram-bot`: reliability, build, line-count, profile-specific Level 5 env proof, mixed access/build Level 5 full-permission proof, and DCL creator mission routing gates passed. Owner handoff patch `docs/r30/patches/r30-telegram-control-reliability-stack.patch` has SHA256 `f17efcc8da0be884dab605cf40fdddfb6da855543e0b1f86a2014fa43c09d89a`; applying the tree-diff patch to public owner base `67ad9e6ed297` produces tree `58fa67eb52e9`, carrying local proof head `3323a656b890` as review/apply material only, not registry or publication authority.
...
- `spark-telegram-bot`: `r30-telegram-control-reliability-stack.patch`
  ...
  `58fa67eb52e9e7f27e0162ce971b0ac137e9aa69`. `git apply` still reports
...
git log --oneline e5a1bd0409865ddb3024c15ed35ccd0038e31776..3323a656b890f88262e88d862e2787c9a2f092ae
...
Range: `e5a1bd0409865ddb3024c15ed35ccd0038e31776..3323a656b890f88262e88d862e2787c9a2f092ae`

Top commits currently in the R30 handoff stack:

- `3323a65 Resolve loop status for new domain chips`
