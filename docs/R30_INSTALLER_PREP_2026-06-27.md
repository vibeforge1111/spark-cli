...
- Local `scripts/installer-manifest.json` points at `spark-cli-public-installer-2026-06-26-r29`.
- Local `scripts/install.sh` and `scripts/install.ps1` also pin R29.
