...
def access_automation_payload(
    *,
    ...
    if not isinstance(next_action, str): next_action = str(next_action or '')
    if not isinstance(recommended_id, str): recommended_id = str(recommended_id or '')
    if not isinstance(level5_activation_state, str): level5_activation_state = str(level5_activation_state or '')
    try:
