    ...
    return {
        ...
        "setup": {
            ...
            "llm_examples": [
                ...
                "spark setup --llm-provider kimi --kimi-api-key @clipboard",
                "spark setup --llm-provider openrouter --openrouter-api-key @clipboard --openrouter-model <MODEL>",
                "spark setup --llm-provider huggingface --huggingface-api-key @clipboard --huggingface-model <MODEL>",
                "spark setup --llm-provider minimax --minimax-api-key @clipboard",
                "spark setup --llm-provider ollama --ollama-url http://localhost:11434 --ollama-model <MODEL>",
                "spark setup --llm-provider openai --openai-api-key @clipboard --openai-model gpt-5.5",
