...
def build_parser() -> argparse.ArgumentParser:
    ...
    os_compile_parser.add_argument("--desktop", default=str(Path.home() / "Desktop") if (Path.home() / "Desktop").exists() else str(Path.home() / ".spark" / "modules"), help="Desktop root containing Spark repos (auto-detected; falls back to ~/.spark/modules on VPS/server installs)")
    ...
    os_capabilities_parser.add_argument("--desktop", default=str(Path.home() / "Desktop") if (Path.home() / "Desktop").exists() else str(Path.home() / ".spark" / "modules"), help="Desktop root containing Spark repos (auto-detected; falls back to ~/.spark/modules on VPS/server installs)")
    ...
    os_authority_parser.add_argument("--desktop", default=str(Path.home() / "Desktop") if (Path.home() / "Desktop").exists() else str(Path.home() / ".spark" / "modules"), help="Desktop root containing Spark repos (auto-detected; falls back to ~/.spark/modules on VPS/server installs)")
    ...
    os_trace_parser.add_argument("--desktop", default=str(Path.home() / "Desktop") if (Path.home() / "Desktop").exists() else str(Path.home() / ".spark" / "modules"), help="Desktop root containing Spark repos (auto-detected; falls back to ~/.spark/modules on VPS/server installs)")
    ...
    os_memory_parser.add_argument("--desktop", default=str(Path.home() / "Desktop") if (Path.home() / "Desktop").exists() else str(Path.home() / ".spark" / "modules"), help="Desktop root containing Spark repos (auto-detected; falls back to ~/.spark/modules on VPS/server installs)")
