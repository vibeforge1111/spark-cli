...
SPARK_CLI_RELEASE_NAME="${SPARK_CLI_RELEASE_NAME:-spark-cli-public-installer-2026-06-26-r29}"
SPARK_DEFAULT_CLI_REF="spark-cli-public-installer-2026-06-26-r29"
