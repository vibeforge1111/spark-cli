...
SPARK_CLI_RELEASE_NAME="${SPARK_CLI_RELEASE_NAME:-spark-cli-public-installer-2026-06-27-r30}"
SPARK_DEFAULT_CLI_REF="spark-cli-public-installer-2026-06-27-r30"
